...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"g","g",1738089905),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([attrs,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"transform","transform",1381301764),["scale(",cljs.core.str.cljs$core$IFn$_invoke$arity$1(scale),") translate(",cljs.core.str.cljs$core$IFn$_invoke$arity$1(x),",",cljs.core.str.cljs$core$IFn$_invoke$arity$1(y),")"].join('')], null)], 0))], null),(function (){var iter__4582__auto__ = (function mecca$transport$iter__59169(s__59170){
return (new cljs.core.LazySeq(null,(function (){
var s__59170__$1 = s__59170;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__59170__$1);
if(temp__5735__auto__){
var s__59170__$2 = temp__5735__auto__;
...
var vec__59189 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__59171);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59189,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59189,(1),null);
cljs.core.chunk_append(b__59172,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"path","path",-188191168),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"stroke","stroke",1741823555),color,new cljs.core.Keyword(null,"d","d",1972142424),path], null)], null));

var G__59298 = (i__59171 + (1));
i__59171 = G__59298;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__59172),mecca$transport$iter__59169(cljs.core.chunk_rest(s__59170__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__59172),null);
}
} else {
var vec__59199 = cljs.core.first(s__59170__$2);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59199,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59199,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"path","path",-188191168),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"stroke","stroke",1741823555),color,new cljs.core.Keyword(null,"d","d",1972142424),path], null)], null),mecca$transport$iter__59169(cljs.core.rest(s__59170__$2)));
}
} else {
return null;
}
...
var G__59217 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"inc-tempo","inc-tempo",-1684511808)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__59217) : re_frame.core.dispatch.call(null,G__59217));
}),(1),x,"all","hidden",(scale * (12))])], null);
});
mecca.transport.tempo_down = (function mecca$transport$tempo_down(x,y,scale){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"rect","rect",-108902628),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"y","y",-1757859776),new cljs.core.Keyword(null,"stroke","stroke",1741823555),new cljs.core.Keyword(null,"width","width",-384071477),new cljs.core.Keyword(null,"on-click","on-click",1632826543),new cljs.core.Keyword(null,"stroke-width","stroke-width",716836435),new cljs.core.Keyword(null,"x","x",2099068185),new cljs.core.Keyword(null,"pointer-events","pointer-events",-1053858853),new cljs.core.Keyword(null,"visibility","visibility",1338380893),new cljs.core.Keyword(null,"height","height",1025178622)],[y,"black",(scale * (12)),(function (){
var G__59223 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"dec-tempo","dec-tempo",375495204)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__59223) : re_frame.core.dispatch.call(null,G__59223));
}),(1),x,"all","hidden",(scale * (12))])], null);
});
...
var G__59231_59327 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"stop","stop",-2140911342)], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__59231_59327) : re_frame.core.dispatch.call(null,G__59231_59327));

return mecca.music.play_sample((17),(63));
})], null),(cljs.core.truth_(cljs.core.deref((function (){var G__59236 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"playing?","playing?",-1884542863)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__59236) : re_frame.core.subscribe.call(null,G__59236));
...
if(cljs.core.truth_(cljs.core.deref((function (){var G__59243 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"playing?","playing?",-1884542863)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__59243) : re_frame.core.subscribe.call(null,G__59243));
})()))){
return mecca.transport.svg_paths.cljs$core$IFn$_invoke$arity$5(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
var G__59247_59343 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pause","pause",-2095325672)], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__59247_59343) : re_frame.core.dispatch.call(null,G__59247_59343));
...
return mecca.transport.svg_paths.cljs$core$IFn$_invoke$arity$5(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
var G__59249_59348 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"play-on","play-on",-1655917734)], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__59249_59348) : re_frame.core.dispatch.call(null,G__59249_59348));
